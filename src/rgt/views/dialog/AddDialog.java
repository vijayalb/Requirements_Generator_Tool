...
public class AddDialog extends JDialog{
	...
	public AddDialog(JFrame rToolView) {
	...
	private void initializeAddDialog() {
		...
		tabbedPane.addTab("<html><body width='120'><center>"+RGTEntities.BUSINESS_PROCESS.getEntity()+"</center></body></html>", 
				null, new AddPanel(RGTEntities.BUSINESS_PROCESS.getEntity()), RGTConstants.TOOLTIP_ADD_TAB1);
		tabbedPane.addTab("<html><body width='120'><center>"+RGTEntities.STEP.getEntity()+"</table></body></html>", 
				null, new AddPanel(RGTEntities.STEP.getEntity()), RGTConstants.TOOLTIP_ADD_TAB2);
		tabbedPane.addTab("<html><body width='120'><center>"+RGTEntities.ACTION.getEntity()+"</table></body></html>", 
				null, new AddPanel(RGTEntities.ACTION.getEntity()), RGTConstants.TOOLTIP_ADD_TAB3);
