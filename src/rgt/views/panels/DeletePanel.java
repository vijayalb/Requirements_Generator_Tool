		...
		businessProcessComboBox.addItemListener(new ItemListener() {
			...
			public void itemStateChanged(ItemEvent event) {
				if (event.getStateChange() == ItemEvent.SELECTED) {
					...
					EditController editCtrl = new EditController();
					List<StepData> steps = editCtrl.getAllSteps(selectedBusinessProcess.getBusinessProcessId());
					
					removeOldComponents();
					
					GridBagConstraints constraints = new GridBagConstraints();
					JLabel stepComboLabel = new JLabel(RGTConstants.LABEL_COMBO_SELECT_STEPS);
					...
					stepComboBox.addItemListener(new ItemListener() {
						...
						public void itemStateChanged(ItemEvent e) {
							StepData selectedStep = (StepData)event.getItem();
							EditController editCtrl = new EditController();
							List<ActionData> actions = editCtrl.getAllActions(selectedStep.getStepId());
							
							removeOldComponents();
							
							GridBagConstraints constraints = new GridBagConstraints();
							JLabel actionComboLabel = new JLabel(RGTConstants.LABEL_COMBO_SELECT_ACTIONS);
							JComboBox<ActionData> actionComboBox = new JComboBox<ActionData>();
