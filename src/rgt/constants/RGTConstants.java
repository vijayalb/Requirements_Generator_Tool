...
public class RGTConstants {
	public static final int EDIT_FRAME_WIDTH = 800;
	public static final int EDIT_FRAME_HEIGHT = 600;
	...
	public static final String  EDIT_FRAME_TITLE = TITLE + "-Edit View";
	public static final String EDIT_FRAME_OUTPUT_PANEL = "Output Panel";
	...
	public static final int EDIT_FRAME_OUTPUT_PANEL_WIDTH = (int) (EDIT_FRAME_WIDTH*0.7);
	public static final int EDIT_FRAME_CONTROL_PANEL_WIDTH = (int) (EDIT_FRAME_WIDTH*0.3);
